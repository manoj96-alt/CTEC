...
class SourceSystem(BaseEntity):
    __tablename__ = "source_systems"

    __table_args__ = (
        Index("idx_source_systems_source_system_name", "source_system_name"),
        Index("idx_source_systems_lifecycle_state", "lifecycle_state"),
        Index("idx_source_systems_effective_from", "effective_from"),
        Index("idx_source_systems_effective_to", "effective_to"),
        Index("idx_source_systems_governance_status", "governance_status"),
        Index("idx_source_systems_created_by", "created_by"),
        Index("idx_source_systems_created_on", "created_on"),
        Index("idx_source_systems_modified_by", "modified_by"),
    ...
    created_by: Mapped[UUID] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_source_systems_created_by",
        ),
        nullable=False,
    )
    ...
    modified_by: Mapped[UUID | None] = mapped_column(
        ...
        ForeignKey(
            "enterprise_entities.enterprise_entity_id",
            name="fk_source_systems_modified_by",
        ),
        nullable=True,
    )
    ...
    previous_version_id: Mapped[UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_source_systems_previous_version_id",
        ),
        nullable=True,
    )
