...
class InstitutionalConcept:
    ...
    institutional_concept_name: CanonicalName
    ...
    def __post_init__(self) -> None:
        for field_name, identifier_value in (
            ("Institutional Concept ID", self.institutional_concept_id),
        ...
        if not isinstance(self.institutional_concept_name, CanonicalName):
            raise ValidationException("Institutional Concept Name must be a Canonical Name")
        ...
        if len(self.institutional_concept_name.value) > 200:
            raise ValidationException("Institutional Concept Name must not exceed 200 characters")
