...
class SourceObject:
    ...
    source_object_name: CanonicalName
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.source_object_name, CanonicalName):
            raise ValidationException("Source Object Name must be a Canonical Name")
        if len(self.source_object_name.value) > 200:
            raise ValidationException("Source Object Name must not exceed 200 characters")
