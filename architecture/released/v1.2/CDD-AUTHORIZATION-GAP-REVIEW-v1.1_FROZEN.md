...
Supersedes: CAGR-001 v1.0

## Purpose

This review identifies whether a CDD that used, referenced, or predated the superseded CDD Template v2.1 has an authorization gap under the exhaustive authorization model mandated by CDS-001 v1.3 and CDD Template v2.2.
