...
Legacy compatibility is governed by PAD-001 v1.5 and EIC-001 v1.3. Existing CDD-010 invocations remain valid and unchanged. They do not acquire AuthorityContext by inference. Trusted control metadata requires a future explicitly identified Protocol Version. Missing, malformed, unsupported, or conflicting version/control metadata is rejected before capability execution according to PAD/EIC; no automatic downgrade, coercion, or default-to-latest behavior is permitted.
