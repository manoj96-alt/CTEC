...
The semantic version of one governed artifact, such as ERM-001 v2.2 or PAD-001 v1.5. Document versions evolve independently from Architecture Baseline versions. Baseline membership is determined by the Architecture Registry and Release Manifest.
...
Dependency examples align with Closure Gate 1 current authorities; terminology is unchanged.
